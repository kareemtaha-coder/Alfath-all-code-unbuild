...
@Component({
  selector: 'app-arabic-course',
  templateUrl: './arabic-course.component.html',
  styleUrls: ['./arabic-course.component.scss'],
  animations: [
    trigger('fadeInOut', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class ArabicCourseComponent implements OnInit {
  isLoading = true;
  progress = 0;
