...
@Component({
  selector: 'app-quran-course',
  templateUrl: './quran-course.component.html',
  styleUrl: './quran-course.component.scss',
  animations: [
    trigger('fadeInOut', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class QuranCourseComponent implements OnInit {
  isLoading = true;
  progress = 0;
